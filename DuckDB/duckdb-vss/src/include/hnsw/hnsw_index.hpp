...
public:
	...
	USearchIndexType::search_result_t saved_search_result;
	...
	idx_t ScanOnly(float *query_vector, idx_t limit, ClientContext &context);
	idx_t ScanAndFilter(float *query_vector, idx_t limit, ClientContext &context, float distance_threshold);
...
private:
	...
	// USearchIndexType::search_result_t AQP_result;
};
